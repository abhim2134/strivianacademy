...
function renderUserEmail(title: string, unsubUrl: string) {
  ...
  <div style="background:#0a0a0b;color:#f4f1ea;font-family:ui-sans-serif,system-ui,sans-serif;padding:32px 24px;max-width:600px;margin:0 auto">
    ...
    <p style="color:#9a9691;margin:0 0 24px 0;font-size:16px">
      Your skill is attached as two markdown files.
    </p>
    ...
    <div style="background:#121214;border:1px solid rgba(244,241,234,0.08);border-radius:12px;padding:20px;margin:0 0 24px 0">
      ...
      <p style="margin:0 0 10px 0;color:#d4d0c7;font-size:14px;line-height:1.6">
        Open Claude Code, drag both attached files into the chat, and say:
      </p>
      <pre style="background:#0a0a0b;border:1px solid rgba(244,241,234,0.08);border-radius:8px;padding:14px;font-size:13px;color:#d4ff3a;overflow:auto;margin:0;white-space:pre-wrap">Create a Claude skill from these two files.</pre>
